    ...
    <>
      {
        activeChat ?
          <div className={props.className}>
            <div className='pt-3 flex justify-between items-center px-5 bg-[#ffff] w-[100%]'>
            ...
            <div className='scrollbar-hide w-[100%] h-[70vh] md:h-[66vh] lg:h-[69vh] flex flex-col overflow-y-scroll px-5'>
            ...
            <div className='absolute left-[10%] bottom-[5%]'>
              ...
              <div className='border-[1px] border-[#aabac8] px-6 py-3 w-[720px] sm:w-[800px] md:w-[700px] h-[50px] lg:w-[800px] rounded-[10px] flex justify-between items-center'>
                ...
                <form onKeyDown={(e) => keyDownFunction(e)} onSubmit={(e) => e.preventDefault()} className='flex-grow px-3'>
                  <input onChange={(e) => {
                  ...
                  }} className='focus:outline-0 w-full bg-[#f8f9fa]' type="text" name="message" placeholder="Enter message" value={message} />
                </form>
                <button onClick={(e) => keyDownFunction(e)} className='bg-[#5851DB] border-[2px] border-[#d4d4d4] text-[14px] px-2 py-[3px] text-[#ffff] font-medium rounded-[7px] -mt-1'>Send</button>
              </div>
            </div>
        </div> :
          <div className={props.className}>
            <div className='relative'>
              <div className='absolute top-[40vh] left-[44%] flex flex-col items-center justify-center gap-y-3'>
                ...
                <h3 className='text-[#111b21] text-[20px] font-medium tracking-wider'>Welcome <span className='text-[#405DE6] text-[19px] font-bold'> {activeUser.name}</span></h3>
              </div>
            </div>
          </div>
